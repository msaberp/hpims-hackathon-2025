"""
AIR-MS Connection Helper (Version without drug_type_concept_id filter)

Use this version if the standard drug_type_concept_id values don't exist in your data.
This analyzes ALL drug exposures regardless of type.
"""
